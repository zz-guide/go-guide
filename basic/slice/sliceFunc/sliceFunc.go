...
// Index returns the first index of the target mystring `t`, or
...
// Include returns `true` if the target mystring t is in the
// slice.
...
// the function `f` to each mystring in the original slice.
